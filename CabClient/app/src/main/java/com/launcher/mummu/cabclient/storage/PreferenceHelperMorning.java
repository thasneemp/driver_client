...
public final class PreferenceHelperMorning {

    private static final String PREF_FILE_NAME = "android_dial_pref_file_morning";

    private static final String PREF_KEY_INSTALL_DATE = "android_dial_install_date_morning";

    private static final String PREF_KEY_LAUNCH_TIMES = "android_dial_launch_times_morning";

    private static final String PREF_KEY_IS_AGREE_SHOW_DIALOG = "android_dial_is_agree_show_dialog_morning";

    private static final String PREF_KEY_REMIND_INTERVAL = "android_dial_remind_interval_morning";

    private PreferenceHelperMorning() {
    }
